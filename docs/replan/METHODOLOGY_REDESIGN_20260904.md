...
> ⚠️ **2026-09-07 纠正**：本节原先引用四份**同济大学**文件。作者不在同济，那套来源整体作废。
> 替代口径由作者当日给出：按国内顶级 985（清华、北大、复旦、上交、浙大、中科大等）的毕业要求做项目
> 约束，且不得借此降级项目。已核实的来源、哈希与实读结论见
> [`../results/PHASE_R1.md` §10](../results/PHASE_R1.md)。

顶级 985 的**校级**规则统一而笼统：《中华人民共和国学位法》第二十条对硕士只要求坚实基础理论、系统专门
知识与从事学术研究的能力，**不要求创新性成果**；第二十一条才对博士追加“在学术研究领域做出创新性成果”；
第二十二条把各学科的具体标准下放给学位授予单位。清华与北大的实施办法逐条复刻这三条，并把具体标准
交给学位评定分委员会。**没有一家在校级文件里写论文数或刊会清单。**

- [中华人民共和国学位法（2024-04-26）](https://www.gov.cn/yaowen/liebiao/202404/content_6947841.htm)
- [清华大学学位授予工作实施办法（2026-02-05）](https://www.tsinghua.edu.cn/info/1236/124249.htm)
- [北京大学学位授予工作实施办法](http://www.dean.pku.edu.cn/web/rules_info.php?id=59)

也就是说，行政文件既没有规定“每个方法章必须 SOTA”或固定方法章数量，**也没有任何一条能被用来降低本项目
的标准**。本项目自定的更高质量目标继续是：三个方法均在统一重跑的公开主指标上超过冻结强基线，并由
matched seeds、document-cluster paired CI、机制消融和端到端风险传播共同支撑。需要修正的是研究问题和实验
方法，不是把失败章节改名为经验章。顶级 985 只作为**雄心的地板**：行政最低线与顶级 985 学科惯例冲突时取更严者。

尚缺一项事实：作者所在单位、学位类型、入学年份和对应学科版授予标准均未在仓库冻结，全部显式记为
`null`。真正卡人的学术门槛在学科分委员会那一层，而单位未知，所以它只影响行政验收矩阵，
不影响上述更高科研目标，也不给降级留口子。
...
1. 作者所在单位、学术/专业学位类型、入学年份和适用的学科授予标准版本（**不是同济**，见 §2 纠正）；
